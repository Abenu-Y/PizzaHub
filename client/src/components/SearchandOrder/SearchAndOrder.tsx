           ...
           transform: 'rotate(0deg)',
            height: '239px',}} /> */}
             <div className="flex flex-row ">
                <div className="relative w-3/4 px-12 top-[100px]">
                    <h1 className="bg-gradient-to-r from-[#FF8100] to-[#FFBE71] bg-clip-text text-transparent text-9xl font-bold py-6">
                            Order us
                    </h1>
                ...
                <div className="relative w-1/4 top-[40px]">
                    <img src={orderUsImage} alt="Pizza" />
                    <img src={leaveImage} alt="Leave image" className="absolute top-[-5px] right-56" />
                </div>
              </div>
        </div>
    </div>
